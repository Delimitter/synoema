...
Run the interactive test dashboard (written in Synoema itself):
...
Synoema includes an MCP server for integration with Claude Desktop, Cursor, Zed, and any MCP-compatible LLM toolchain.
...
Provides tools: `eval`, `typecheck`, `run`. Resources: language reference, LLM quick reference, examples.

Full documentation: [docs/mcp.md](docs/mcp.md) · Pre-built binaries: [releases/](releases/)
