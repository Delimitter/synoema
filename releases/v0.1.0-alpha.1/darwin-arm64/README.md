# Synoema v0.1.0-alpha.1 — macOS Apple Silicon (darwin-arm64)
...
```bash
curl -L https://github.com/Delimitter/synoema/releases/download/v0.1.0-alpha.1/synoema-0.1.0-alpha.1-darwin-arm64 \
  -o synoema
